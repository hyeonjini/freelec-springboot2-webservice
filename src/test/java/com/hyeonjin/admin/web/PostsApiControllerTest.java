...
public class PostsApiControllerTest {
    // @WebMvcTest를 사용하지 않음 -> JPA 기능이 동작하지 않기 때문
    // Controller, ControllerAdvice 등 외부 연동과 관련된 부분만 활성화됨
    // JPA 기능가지 한번에 테스트할땐 @SpringBootTest + TestRestTemplate를 사용
